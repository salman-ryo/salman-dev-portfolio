...
export const metadata = {
  title: "Dev Salman",
  description: "Salman's Full Stack portfolio site",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`relative ${inter.className} bg-slate-100 dark:bg-gradient-to-tr from-black via-[#000929] to-[#2b034a] text-gray-950 dark:text-gray-300 pt-28 sm:pt-36`}>
