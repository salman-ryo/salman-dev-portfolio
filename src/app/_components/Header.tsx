            ...
            >
              ...
              >
                ...
                >
                  ...
                  {link.name === activeTab && (
                    <motion.span
                      className="-z-10 bg-gray-300 dark:bg-cyan-200 rounded-full absolute inset-0"
                      layoutId="activeTab"
                      transition={{
                        type: "sping",
                        stiffness: 400,
